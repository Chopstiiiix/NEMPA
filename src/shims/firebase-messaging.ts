...
// @capacitor-firebase/messaging. NEMPA uses push on native only
...
const unsupported = (name: string) => () => {
  throw new Error(`firebase/messaging.${name} is not available: NEMPA web build does not use FCM web push.`);
};
